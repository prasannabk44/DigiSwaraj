...
import ProductDetailsText from "../RetailerPage/ProductDetailsText";
import ProductImgSidebar from "../RetailerPage/ProductImgSidebar";
import { CheckSquare, StarFill } from "react-bootstrap-icons";
import ProductRetailerZoom from "../RetailerPage/ProductRetailerZoom";
      ...
      <Container fluid>
        ...
        <Row>
          <Col xs={12} sm={12} md={6}>
            <Row>
              <h6 className="seller-price">SELL PRICE</h6>{" "}
              <input type="text" placeholder="resell at price" />{" "}
              <h6 className="seller-price"> Tr Price-Rs 600</h6> Margin 20%{" "}
              {"  "} <CheckSquare />{" "}
              <h6 className="seller-price">ADD TO MY-STORE</h6>
            </Row>
